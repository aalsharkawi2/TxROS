...
namespace RosSharp.RosBridgeClient.Actionlib
{
        ...
        where TFeedback : Message
    {
        ...
        {
            statusPublicationID = rosSocket.Advertise<GoalStatusArray>(actionName + "/status", "std_msgs/String"); // added "std_msgs/String"
            feedbackPublicationID = rosSocket.Advertise<TActionFeedback>(actionName + "/feedback", "std_msgs/String"); // added "std_msgs/String"
            resultPublicationID = rosSocket.Advertise<TActionResult>(actionName + "/result", "std_msgs/String"); // added "std_msgs/String"
