...
namespace RosSharp.RosBridgeClient.Actionlib
{
        ...
        where TFeedback : Message
    {
        ...
        {
            cancelPublicationID = rosSocket.Advertise<GoalID>(actionName + "/cancel", "std_msgs/String"); // added "std_msgs/String"
            goalPublicationID = rosSocket.Advertise<TActionGoal>(actionName + "/goal", "std_msgs/String"); // added "std_msgs/String"
